describe('User Routes Test', () => {
    it('GET users route', () => {
      ...
      cy.wait(1000)
      cy.get('[href="/menu-management/edit/foods"]').click()
       
       cy.get('#addnewsub').click()
        cy.get('#subcatname > .font-sora').type('pastry', { delay: 200 })
        cy.wait(2000)
        cy.get('.addsub > .my-10 > div > .w-full').click()
        cy.get('#pv_id_5_0_content > .p-5 > .-space-x-5 > .mx-5 > .bg-offwhite').click()
        cy.get('.productname').click()
        cy.get('.productname').type('chocolate cake', { delay: 200 })
        cy.get('#unitprice').click()
        cy.get('#unitprice').type('10', { delay: 200 })
        cy.get('#stock').click()
        cy.get('#stock').type('100', { delay: 200 })
        cy.wait(2000)
        cy.get('.add > .my-10 > div > .w-full').click()
        cy.get('#pv_id_5_0_content > .p-5 > .-space-x-5 > :nth-child(2) > .h-full > .w-16').click()
        cy.wait(2000)
